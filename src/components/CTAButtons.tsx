...
const CTAButtons = () => {
  ...
  return (
    <div className="flex w-[300px] max-w-full flex-col items-stretch mt-[37px]">
      <button
        className="flex min-h-[55px] w-full items-center gap-2 text-lg text-white font-medium justify-center px-3.5 py-[17px] rounded-[39px] bg-[rgba(68,127,115,1)] hover:bg-[rgba(58,117,105,1)] transition-colors focus:outline-none focus:ring-2 focus:ring-[rgba(68,127,115,1)] focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
